...
QTableWidget, QLabel, QVBoxLayout, QWidget, QTableWidgetItem)
...
class ContactList(QMainWindow):
    ...
    def __on_add_contact(self) -> None:
        """Slot for Add Contact button click listener."""
        ...
        if name and phone:
            ...
            self.status_label.setText("Please enter a contact name and phone "
                                      "number.")
